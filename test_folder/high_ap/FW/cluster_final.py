...
def parse_arguments():
    ...
    parser.add_argument('-t', '--topology', default="centered_FW_1129_1320.gro", help='Topology file (e.g., .gro, .pdb)')
    parser.add_argument('-x', '--trajectory', default="centered_FW_1129_1320.xtc", help='Trajectory file (e.g., .xtc, .trr)')
    parser.add_argument('--first', type=int, default=4765, help='First frame to analyze')
    parser.add_argument('--last', type=int, default=4766, help='Last frame to analyze')
