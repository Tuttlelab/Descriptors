...
def plot_multi_scale_evolution(df, transitions, timestamp):
    ...
    plt.tight_layout()
    plt.savefig(f'FF/evolution_{timestamp}.png',
...
def load_structure_data():
    ...
    try:
        sheets_df = pd.read_csv('FF/sfi_output.csv')
        vesicles_df = pd.read_csv('FF/vfi_output.csv')
        tubes_df = pd.read_csv('FF/tfi_output.csv')
        fibers_df = pd.read_csv('FF/ffi_output.csv')
...
def main():
    ...
    results.to_csv(f'FF/evolution_{timestamp}.csv', index=False)
