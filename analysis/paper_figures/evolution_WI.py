...
def plot_multi_scale_evolution(df, transitions, timestamp):
    ...
    plt.tight_layout()
    plt.savefig(f'WI/evolution_{timestamp}.png',
...
def load_structure_data():
    ...
    try:
        sheets_df = pd.read_csv('WI/sfi_output.csv')
        vesicles_df = pd.read_csv('WI/vfi_output.csv')
        tubes_df = pd.read_csv('WI/tfi_output.csv')
        fibers_df = pd.read_csv('WI/ffi_output.csv')
...
def main():
    ...
    results.to_csv(f'WI/evolution_{timestamp}.csv', index=False)
