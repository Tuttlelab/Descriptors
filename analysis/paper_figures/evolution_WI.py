...
def plot_multi_scale_evolution(df, transitions, timestamp, data_dir='WI'):
...
def load_structure_data(data_dir='WI'):
...
def main():
    parser = argparse.ArgumentParser(description="Evolution analysis for WI peptide structural transitions.")
